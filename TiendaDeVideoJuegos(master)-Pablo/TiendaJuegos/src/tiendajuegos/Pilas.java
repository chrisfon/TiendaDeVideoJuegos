...
//    }
    ...
    public int montoTotal() {
        ...
        NodoPila aux = top;
        while (aux != null) {
            if (aux.getJuego() != null) {
                montoTotal += aux.getJuego().getPrecioJuego();
            }
            if (aux.getAparato() != null) {
                montoTotal += aux.getAparato().getPrecioAparato();
            }
            if (aux.getCombos() != null) {
                montoTotal += aux.getCombos().getPrecioCombo();
            }
            aux = aux.getAbajo();
        }
